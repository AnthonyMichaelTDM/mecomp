...
mod tests {
    ...
    fn test_geometric_mean() {
        ...
        assert!(
            0.0001 > (3.668016172818685 - geometric_mean(&numbers)).abs(),
            "{} !~= {}",
            geometric_mean(&numbers),
            3.668016172818685
        );
        ...
        assert!(
            0.0001 > (1.8340080864093417e-05 - geometric_mean(&subnormal)).abs(),
            "{} !~= {}",
            geometric_mean(&subnormal),
            1.8340080864093417e-05
        );
        ...
        assert!(
            0.00000001 > (0.0025750597 - geometric_mean(&input)).abs(),
            "{} !~= 0.0025750597",
