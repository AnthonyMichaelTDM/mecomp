...
pub trait MusicPlayer {
    ...
    async fn search(query: String, limit: i64) -> (Box<[Song]>, Box<[Album]>, Box<[Artist]>);
    /// returns a list of artists matching the given search query.
    async fn search_artist(query: String, limit: i64) -> Box<[Artist]>;
    /// returns a list of albums matching the given search query.
    async fn search_album(query: String, limit: i64) -> Box<[Album]>;
    /// returns a list of songs matching the given search query.
    async fn search_song(query: String, limit: i64) -> Box<[Song]>;
